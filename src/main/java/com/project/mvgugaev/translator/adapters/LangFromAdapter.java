...
// Text language adapter (use in ListView)

public class LangFromAdapter extends ArrayAdapter <Lang> {
    private Context parentContext;
    private LayoutInflater lInflater;
    private ArrayList <Lang> objects; // All languages

    public LangFromAdapter(Context context, ArrayList <Lang> langs) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item.getTransKey().equals("full_h")) {
            ...
            rowView = lInflater.inflate(MyApplication.getLangFrom().equals(item) ? R.layout.lang_row_picked : R.layout.lang_row, parent, false);
